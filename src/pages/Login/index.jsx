...
const Login = () => {
  ...
  //   untuk menangani penyimpanan Token Akses
  useEffect(() => {
    const accessToken = localStorage.getItem("accessToken");
    console.log("token", accessToken);
  }, []);

  // Efek untuk mengelola timeout pada pesan logout sukses
  useEffect(() => {
    let fadeTimeout;
    ...
    <div className="login-wrapper">
      ...
      <div className="login-form">
        ...
        <div className="login-with">
          ...
          <div className="login-with-links">
            ...
            <div className="login-logo facebook">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="45"
                height="45"
            ...
            <div className="login-logo appleId">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="45"
                height="45"
