...
const Navbar = () => {
  ...
  const handleConfirmLogout = () => {
    ...
    //  bikin alert bahwa sudah berhasil logout
  ...
  return (
    <nav className={toggle ? "navbar expanded" : "navbar"}>
      ...
      {/* Navbar links */}
      <div className={`nav-links ${showAlert ? "disabled" : ""}`}>
        <ScrollLink
          className="link-nav"
          to="cards"
          spy={true}
          ...
          <div className="alert-overlay">
            <div className="alert-box">
              ...
              <div className="alert-buttons">
                <button className="cancel-logout" onClick={handleCancelLogout}>
                  Cancel
                </button>
                <button
        ...
        <div className="link-nav">
          {accessToken ? (
            <Link className="changed-link">
              <p onClick={handleLogout} className="p-menu">
                Logout
              </p>
            </Link>
          ) : (
            <Link className="changed-link" to="/login">
        ...
        <div>
          <ScrollLink
            ...
            duration={500}
          >
            <button className="link-nav btn">Contact Us</button>
          </ScrollLink>
        </div>
      </div>
